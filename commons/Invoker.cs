    ...
    public class invoker
    {
        ...
        public object get(string apiDefination, Type dataType)
        {
            ...
            try
            {
                ...
                _path = ConfigurationManager.AppSettings["path"].ToString();
                url = string.Format("{0}{1}?quantity={2}&key={3}", _path, apiDefination, ConfigurationManager.AppSettings["quantity"].ToString(), ConfigurationManager.AppSettings["key"].ToString());                
